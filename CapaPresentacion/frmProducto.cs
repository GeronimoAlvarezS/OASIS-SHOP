...
namespace CapaPresentacion
{
    public partial class frmProducto : Form
    {
        ...
        private void frmProducto_Load(object sender, EventArgs e)
        {
            ...
            cbocategoria.Items.Add(new OpcionCombo() { Valor = 0, Texto = "-- Seleccione una categoría --" });
            ...
            cbocategoria.SelectedIndex = 0; // selecciona el texto inicial
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(((OpcionCombo)cbocategoria.SelectedItem).Valor) == 0)
            {
                MessageBox.Show("Debe seleccionar una categoría válida.", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        private void Limpiar()
        {
            ...
            cbocategoria.SelectedIndex = 0; // vuelve a “Seleccione una categoría”
            cboestado.SelectedIndex = 0;
            txtcodigo.Select();
        }
